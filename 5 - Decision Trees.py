...
When the response variable is categorical, the model is called a
    Classification tree.
    When it is numerical, the model is called a regression tree.
    This is why we talk about classification and regression trees (CART)

Check the link below to read about the advantages and disadvantages of
    using Decision Trees:
    https://scikit-learn.org/stable/modules/tree.html

Random Forests (RF) is an ensemble of decision trees
"""
...
path = "file path/lending_club_data01.csv"
...
def evaluate_model_cart():
    ...
    # we see that when the 'good_loans' value == yes, the model
    # performs better
...
def evaluate_model_random_forest_classification():
    ...
    # we see that when the 'good_loans' value == yes, the model
    # performs better.
    # Also, RF classifies better than Decision Trees.
    # Is it good to always use ensembles?
...
"""
7. Let Us now Use a Larger Dataset
"""

# Check the code in the next file ( 6 - Decision Trees - 2)
